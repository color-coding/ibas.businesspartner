...
namespace businesspartner {
    export namespace app {
        ...
        /** 编辑应用-业务伙伴组 */
        export class BusinessPartnerGroupEditApp extends ibas.BOEditService<IBusinessPartnerGroupEditView, bo.BusinessPartnerGroup> {

            /** 应用标识 */
            static APPLICATION_ID: string = "2ea8d9d8-bf60-4b5f-bc24-5031a5ce1893";
            /** 应用名称 */
            static APPLICATION_NAME: string = "businesspartner_app_businesspartnergroup_edit";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.BusinessPartnerGroup.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = BusinessPartnerGroupEditApp.APPLICATION_ID;
                this.name = BusinessPartnerGroupEditApp.APPLICATION_NAME;
                this.boCode = BusinessPartnerGroupEditApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewShowed(): void {
                ...
                if (ibas.objects.isNull(this.editData)) {
                    // 创建编辑对象实例
                    this.editData = new bo.BusinessPartnerGroup();
                    this.proceeding(ibas.emMessageType.WARNING, ibas.i18n.prop("shell_data_created_new"));
                }
                this.view.showBusinessPartnerGroup(this.editData);
            }
            /** 运行,覆盖原方法 */
            run(): void;
            ...
            run(): void {
                ...
                if (ibas.objects.instanceOf(arguments[0], bo.BusinessPartnerGroup)) {
                    let data: bo.BusinessPartnerGroup = arguments[0];
                    // 新对象直接编辑
                    if (data.isNew) {
                        that.editData = data;
                        that.show();
            ...
            protected createData(clone: boolean): void {
                ...
                let createData: Function = function (): void {
                    if (clone) {
                        ...
                        // 新建对象
                        that.editData = new bo.BusinessPartnerGroup();
        ...
        export class BusinessPartnerGroupEditServiceMapping extends ibas.BOEditServiceMapping {
            /** 构造函数 */
            constructor() {
                super();
                this.id = BusinessPartnerGroupEditApp.APPLICATION_ID;
            ...
            create(): ibas.IService<ibas.IBOEditServiceCaller<bo.BusinessPartnerGroup>> {
                return new BusinessPartnerGroupEditApp();
            }
        }
    }
}
