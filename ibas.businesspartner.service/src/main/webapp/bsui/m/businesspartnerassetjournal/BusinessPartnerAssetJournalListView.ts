        ...
        export namespace m {
            ...
            export class BusinessPartnerAssetJournalListView extends ibas.BOListView implements app.IBusinessPartnerAssetJournalListView {
                                        ...
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press(oEvent: any): void {
                                                ...
                                                that.fireViewEvents(that.deleteDataEvent,
                                                    openui5.utils.getSelecteds<bo.BusinessPartnerAssetJournal>(that.list)
                                                );
                                            }
                                        }),
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press(oEvent: any): void {
                                                ...
                                                that.fireViewEvents(that.editDataEvent,
                                                    openui5.utils.getSelecteds<bo.BusinessPartnerAssetJournal>(that.list).firstOrDefault()
                                                );
                                            }
                                        })
                                    ]
                ...
                getSelecteds(): bo.BusinessPartnerAssetJournal[] {
                    return openui5.utils.getSelecteds<bo.BusinessPartnerAssetJournal>(this.list);
                }
                /** 手指触控滑动 */
