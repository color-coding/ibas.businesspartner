...
namespace businesspartner {
    export namespace app {
        /** 列表应用-付款条款 */
        export class PaymentTermListApp extends ibas.BOListApplication<IPaymentTermListView, bo.PaymentTerm> {
            /** 应用标识 */
            static APPLICATION_ID: string = "e08613bd-2643-48e5-8f95-72a1eb8e14ec";
            /** 应用名称 */
            static APPLICATION_NAME: string = "businesspartner_app_paymentterm_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.PaymentTerm.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = PaymentTermListApp.APPLICATION_ID;
                this.name = PaymentTermListApp.APPLICATION_NAME;
                this.boCode = PaymentTermListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.PaymentTerm): void {
                ...
                let app: PaymentTermViewApp = new PaymentTermViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.PaymentTerm | bo.PaymentTerm[]): void {
                let beDeleteds: ibas.IList<bo.PaymentTerm> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-付款条款 */
        export interface IPaymentTermListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
