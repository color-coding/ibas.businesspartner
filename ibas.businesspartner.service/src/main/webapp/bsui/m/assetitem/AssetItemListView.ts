...
namespace businesspartner {
    export namespace ui {
        export namespace m {
            /** 列表视图-资产项目 */
            export class AssetItemListView extends ibas.BOListView implements app.IAssetItemListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.AssetItem;
                }
                                        ...
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press(oEvent: any): void {
                                                ...
                                                that.fireViewEvents(that.deleteDataEvent,
                                                    openui5.utils.getSelecteds<bo.AssetItem>(that.list)
                                                );
                                            }
                                        }),
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press(oEvent: any): void {
                                                ...
                                                that.fireViewEvents(that.editDataEvent,
                                                    openui5.utils.getSelecteds<bo.AssetItem>(that.list).firstOrDefault()
                                                );
                                            }
                                        })
                                    ]
                ...
                getSelecteds(): bo.AssetItem[] {
                    return openui5.utils.getSelecteds<bo.AssetItem>(this.list);
                }
                /** 手指触控滑动 */
