...
namespace businesspartner {
    export namespace bo {
        ...
        /** 供应商 */
        export class Supplier extends ibas.BOMasterData<Supplier> implements ISupplier {
            ...
            /** 获取-标识 */
            get sign(): string {
                return this.getProperty<string>(Supplier.PROPERTY_SIGN_NAME);
            }
            /** 设置-标识 */
            set sign(value: string) {
                this.setProperty(Supplier.PROPERTY_SIGN_NAME, value);
            }
            ...
            get activated(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Supplier.PROPERTY_ACTIVATED_NAME);
            }
            /** 设置-激活 */
            ...
            get warehouse(): string {
                return this.getProperty<string>(Supplier.PROPERTY_WAREHOUSE_NAME);
            }
            /** 设置-仓库 */
            set warehouse(value: string) {
                this.setProperty(Supplier.PROPERTY_WAREHOUSE_NAME, value);
            }
            ...
            get floorList(): number {
                return this.getProperty<number>(Supplier.PROPERTY_FLOORLIST_NAME);
            }
            /** 设置-底价清单 */
            set floorList(value: number) {
                this.setProperty(Supplier.PROPERTY_FLOORLIST_NAME, value);
            }
            ...
            /** 获取-税收组 */
            get taxGroup(): string {
                return this.getProperty<string>(Supplier.PROPERTY_TAXGROUP_NAME);
            }
            /** 设置-税收组 */
            ...
            get referenced(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Supplier.PROPERTY_REFERENCED_NAME);
            }
            /** 设置-已引用 */
            ...
            get deleted(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Supplier.PROPERTY_DELETED_NAME);
            }
            /** 设置-已删除 */
            ...
            get approvalStatus(): ibas.emApprovalStatus {
                return this.getProperty<ibas.emApprovalStatus>(Supplier.PROPERTY_APPROVALSTATUS_NAME);
            }
            /** 设置-审批状态 */
            ...
            /** 初始化数据 */
            protected init(): void {
                this.objectCode = ibas.config.applyVariables(Supplier.BUSINESS_OBJECT_CODE);
