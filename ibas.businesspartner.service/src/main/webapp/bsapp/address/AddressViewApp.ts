...
/** 查看应用-业务伙伴地址 */
export class AddressViewApp extends ibas.BOViewService<IAddressViewView> {

    /** 应用标识 */
    static APPLICATION_ID: string = "81982a99-aa33-4993-9024-abb173c2fe03";
    /** 应用名称 */
