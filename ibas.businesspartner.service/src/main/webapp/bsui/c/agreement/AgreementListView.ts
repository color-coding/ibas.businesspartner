...
namespace businesspartner {
    export namespace ui {
        export namespace c {
            /** 列表视图-协议/合同 */
            export class AgreementListView extends ibas.BOListView implements app.IAgreementListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.Agreement;
                }
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_agreement_code"),
                                template: new sap.extension.m.DataLink("", {
                                    objectCode: bo.Agreement.BUSINESS_OBJECT_CODE,
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_agreement_name"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_agreement_category"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_agreement_activated"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "activated",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_agreement_businesspartnertype"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_agreement_abstracts"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "abstracts",
                                    type: new sap.extension.data.Alphanumeric(),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_agreement_remarks"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "remarks",
                                    type: new sap.extension.data.Alphanumeric(),
