                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_lead_code"),
                                template: new sap.extension.m.DataLink("", {
                                    objectCode: bo.Lead.BUSINESS_OBJECT_CODE,
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_lead_name"),
                                width: "16rem",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_lead_activated"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "activated",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_lead_group"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_lead_channel"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "channel",
                                    type: new sap.extension.data.Alphanumeric()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_lead_remarks"),
                                width: "20rem",
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "remarks",
