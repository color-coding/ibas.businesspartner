...
namespace businesspartner {
    export namespace ui {
        export namespace m {
            /** 编辑视图-业务伙伴资产日记账 */
            export class BusinessPartnerAssetJournalEditView extends ibas.BOEditView implements app.IBusinessPartnerAssetJournalEditView {
                /** 删除数据事件 */
                ...
                draw(): any {
                    let that: this = this;
                    this.pageBusinessPartnerAssetJournal = new sap.m.Page("", {
                        showHeader: false,
                        showfooter: false,
                        content: [
                    ...
                    this.navContainer = new sap.m.NavContainer("", {
                        pages: [
                            this.pageBusinessPartnerAssetJournal,
                        ]
                    });
                    ...
                    this.toPage(this.pageBusinessPartnerAssetJournal);
                    return this.page;
                }

                private page: sap.m.Page;
                private pageBusinessPartnerAssetJournal: sap.m.Page;
                ...
                private toPage(page: sap.m.Page, leftToRight?: boolean): void {
                    switch (page) {
                        case this.pageBusinessPartnerAssetJournal:
                            this.navButton.setVisible(true);
                            this.currentPage = this.pageBusinessPartnerAssetJournal;
                            break;
                        default:
                            break;
                    }
                ...
                /** 改变视图状态 */
                private changeViewStatus(data: bo.BusinessPartnerAssetJournal): void {
                ...
                showBusinessPartnerAssetJournal(data: bo.BusinessPartnerAssetJournal): void {
                    this.pageBusinessPartnerAssetJournal.setModel(new sap.ui.model.json.JSONModel(data));
                    this.pageBusinessPartnerAssetJournal.bindObject("/");
                    // 监听属性改变，并更新控件
                    openui5.utils.refreshModelChanged(this.pageBusinessPartnerAssetJournal, data);
                    // 改变视图状态
