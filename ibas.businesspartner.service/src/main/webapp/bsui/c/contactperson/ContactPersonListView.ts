...
export class ContactPersonListView extends ibas.BOListView implements IContactPersonListView {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ContactPerson>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ContactPerson>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.ContactPerson[] {
        return utils.getTableSelecteds<bo.ContactPerson>(this.table);
    }
}
