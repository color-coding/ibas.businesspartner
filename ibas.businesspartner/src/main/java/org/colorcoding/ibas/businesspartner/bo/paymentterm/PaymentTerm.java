...
public class PaymentTerm extends BusinessObject<PaymentTerm> implements IPaymentTerm, IBOSeriesKey {
	 ...
	 * 起始于 属性
	 */
	@DbField(name = "PayDuMonth", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 附加月数 属性
	 */
	@DbField(name = "ExtraMonth", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 附加天数 属性
	 */
	@DbField(name = "ExtraDays", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 到期日基于 属性
	 */
	@DbField(name = "BslineDate", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 容差天数 属性
	 */
	@DbField(name = "TolDays", type = DataType.NUMERIC, table = DB_TABLE_NAME)
