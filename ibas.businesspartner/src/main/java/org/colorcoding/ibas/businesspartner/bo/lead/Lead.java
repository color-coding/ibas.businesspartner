package org.colorcoding.ibas.businesspartner.bo.lead;
...
@XmlType(name = Lead.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Lead.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = Lead.BUSINESS_OBJECT_CODE)
public class Lead extends BusinessObject<Lead>
		implements ILead, IDataOwnership, IApprovalData, IBOSeriesKey, IBOTagDeleted, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -6202089723899929571L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Lead.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_BP_OLED";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_BP_LEAD";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Lead";
	 ...
	 * 公司/个人 属性
	 */
	@DbField(name = "CmpPrivate", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 联系人 属性
	 */
	@DbField(name = "CntctPrsn", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 账单地址 属性
	 */
	@DbField(name = "BillAddress", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 送货地址 属性
	 */
	@DbField(name = "ShipAddress", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 属性名称-注册地址
	 */
	private static final String PROPERTY_REGISTRATIONADDRESS_NAME = "RegistrationAddress";

	/**
	 * 注册地址 属性
	 */
	@DbField(name = "RegsAddress", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<Integer> PROPERTY_REGISTRATIONADDRESS = registerProperty(
			PROPERTY_REGISTRATIONADDRESS_NAME, Integer.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_REGISTRATIONADDRESS_NAME)
	public final Integer getRegistrationAddress() {
		return this.getProperty(PROPERTY_REGISTRATIONADDRESS);
	}
	 ...
	 * @param value 值
	 */
	public final void setRegistrationAddress(Integer value) {
		this.setProperty(PROPERTY_REGISTRATIONADDRESS, value);
	}
	 ...
	 * 电话 1 属性
	 */
	@DbField(name = "Phone1", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 电话 2 属性
	 */
	@DbField(name = "Phone2", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 移动电话 属性
	 */
	@DbField(name = "Cellular", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 传真号 属性
	 */
	@DbField(name = "Fax", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 税收组 属性
	 */
	@DbField(name = "TaxGroup", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 所属渠道 属性
	 */
	@DbField(name = "Channel", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 组织单位 属性
	 */
	@DbField(name = "OrgUnit", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
