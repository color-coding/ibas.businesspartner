...
namespace businesspartner {
    export namespace ui {
        export namespace c {
             ...
             * 列表视图-业务伙伴联系人
             */
            export class ContactPersonListView extends ibas.BOListView implements app.IContactPersonListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                ...
                                template: new sap.extension.m.DataLink("", {
                                    objectCode: bo.ContactPerson.BUSINESS_OBJECT_CODE,
                                    ...
                                    press(): void {
                                        ...
                                        if (data instanceof bo.ContactPerson) {
                                            ibas.servicesManager.runLinkService({
                                                boCode: data.ownerType === bo.emBusinessPartnerType.SUPPLIER ?
                                                    bo.Supplier.BUSINESS_OBJECT_CODE : data.ownerType === bo.emBusinessPartnerType.CUSTOMER
                                                        ? bo.Customer.BUSINESS_OBJECT_CODE : bo.Lead.BUSINESS_OBJECT_CODE,
                                                linkValue: data.businessPartner,
                                            });
                                        }
                                    }
                                }).bindProperty("bindingValue", {
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_contactperson_group"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_contactperson_remark1"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "remark1",
                                    type: new sap.extension.data.Alphanumeric()
