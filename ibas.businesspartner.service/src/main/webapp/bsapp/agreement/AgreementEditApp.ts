...
namespace businesspartner {
    export namespace app {
        ...
        export class AgreementEditApp extends ibas.BOEditApplication<IAgreementEditView, bo.Agreement> {
            ...
            /** 应用名称 */
            static APPLICATION_NAME: string = "businesspartner_app_agreement_edit";
            /** 业务对象编码 */
            ...
            protected viewShowed(): void {
                ...
                if (ibas.objects.isNull(this.editData)) {
                    // 创建编辑对象实例
                    this.editData = new bo.Agreement();
                    this.proceeding(ibas.emMessageType.WARNING, ibas.i18n.prop("shell_data_created_new"));
                }
                this.view.showAgreement(this.editData);
            }
            run(): void;
            ...
            protected createData(clone: boolean): void {
                ...
                let createData: Function = function (): void {
                    if (clone) {
                        ...
                        // 新建对象
                        that.editData = new bo.Agreement();
        ...
        /** 视图-协议/合同 */
        export interface IAgreementEditView extends ibas.IBOEditView {
            /** 显示数据 */
