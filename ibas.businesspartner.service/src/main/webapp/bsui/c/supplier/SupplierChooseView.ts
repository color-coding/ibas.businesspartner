...
import { ISupplierChooseView } from "../../../bsapp/supplier/index";

/**
 * 选择视图-业务伙伴-供应商
 */
export class SupplierChooseView extends ibas.BOChooseView implements ISupplierChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.Supplier;
    }
            ...
            new sap.m.Button("", {
                ...
                press: function (): void {
                    that.fireViewEvents(that.chooseDataEvent,
                        // 获取表格选中的对象
                        utils.getTableSelecteds<bo.Supplier>(that.table)
                    );
                }
            }),
            new sap.m.Button("", {
    ...
    darw(): any {
        ...
        this.table = new sap.ui.table.Table("", {
            ...
            columns: [
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_supplier_contactperson"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "contactPerson"
