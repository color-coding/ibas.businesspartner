...
namespace businesspartner {
    export namespace ui {
        export namespace c {
            /** 查看视图-潜在客户 */
            export class LeadViewView extends ibas.BOViewView implements app.ILeadViewView {
                /** 绘制视图 */
                draw(): any {
                    let that: this = this;
                                ...
                                subSections: [
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            ...
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_floorlist"),
                                                repository: materials.bo.BORepositoryMaterials,
                                                dataInfo: {
                                                    type: materials.bo.MaterialPriceList,
                                                    key: materials.bo.MaterialPriceList.PROPERTY_OBJECTKEY_NAME,
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                ...
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_contactperson"),
                                                repository: bo.BORepositoryBusinessPartner,
                                                dataInfo: {
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_mobilephone"),
                                                bindingValue: {
                                                    path: "mobilePhone",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_faxnumber"),
                                                bindingValue: {
                                                    path: "faxNumber",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_shipaddress"),
                                                repository: bo.BORepositoryBusinessPartner,
                                                dataInfo: {
                                                    type: bo.Address,
                                            ...
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_billaddress"),
                                                repository: bo.BORepositoryBusinessPartner,
                                                dataInfo: {
                                                    type: bo.Address,
                                                    key: bo.Address.PROPERTY_OBJECTKEY_NAME,
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            ...
                                            new sap.extension.m.UserObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_dataowner"),
                                                bindingValue: {
                                                    path: "dataOwner",
                                                    type: new sap.extension.data.Numeric(),
                                                }
                                            ...
                                            new sap.extension.m.OrganizationObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_lead_organization"),
                                                bindingValue: {
                                                    path: "organization",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
