                        ...
                        headerTitle: new sap.uxap.ObjectPageHeader("", {
                            ...
                            actions: [
                                new sap.extension.m.ObjectEnumStatus("", {
                                    title: ibas.i18n.prop("bo_customer_companyprivate"),
                                    text: {
                                        path: "companyPrivate",
                                ...
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            ...
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_warehouse"),
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_currency"),
                                                bindingValue: {
                                                    path: "currency",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                            ...
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_floorlist"),
                                                repository: materials.bo.BORepositoryMaterials,
                                                dataInfo: {
                                                    type: materials.bo.MaterialPriceList,
                                                    key: materials.bo.MaterialPriceList.PROPERTY_OBJECTKEY_NAME,
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                ...
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_contactperson"),
                                                repository: bo.BORepositoryBusinessPartner,
                                                dataInfo: {
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_mobilephone"),
                                                bindingValue: {
                                                    path: "mobilePhone",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_faxnumber"),
                                                bindingValue: {
                                                    path: "faxNumber",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_shipaddress"),
                                                repository: bo.BORepositoryBusinessPartner,
                                                dataInfo: {
                                                    type: bo.Address,
                                            ...
                                            new sap.extension.m.RepositoryObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_billaddress"),
                                                repository: bo.BORepositoryBusinessPartner,
                                                dataInfo: {
                                                    type: bo.Address,
                                                    key: bo.Address.PROPERTY_OBJECTKEY_NAME,
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                ...
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_invoicetitle"),
                                                bindingValue: {
                                                    path: "invoiceTitle",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_taxid"),
                                                bindingValue: {
                                                    path: "taxId",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_invoiceaddress"),
                                                bindingValue: {
                                                    path: "invoiceAddress",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_bank"),
                                                bindingValue: {
                                                    path: "bank",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                            ...
                                            new sap.extension.m.ObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_bankaccount"),
                                                bindingValue: {
                                                    path: "bankAccount",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            ...
                                            new sap.extension.m.UserObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_dataowner"),
                                                bindingValue: {
                                                    path: "dataOwner",
                                                    type: new sap.extension.data.Numeric(),
                                                }
                                            ...
                                            new sap.extension.m.OrganizationObjectAttribute("", {
                                                title: ibas.i18n.prop("bo_customer_organization"),
                                                bindingValue: {
                                                    path: "organization",
                                                    type: new sap.extension.data.Alphanumeric(),
                                                }
