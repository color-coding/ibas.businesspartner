...
export class BusinessPartnerBalanceJournalEditApp extends
    ...
    /** 应用名称 */
    static APPLICATION_NAME: string = "businesspartner_app_businesspartnerbalancejournal_edit";
    /** 业务对象编码 */
    static BUSINESS_OBJECT_CODE: string = bo.BusinessPartnerBalanceJournal.BUSINESS_OBJECT_CODE;
    /** 构造函数 */
    constructor() {
        super();
        this.id = BusinessPartnerBalanceJournalEditApp.APPLICATION_ID;
        this.name = BusinessPartnerBalanceJournalEditApp.APPLICATION_NAME;
        this.boCode = BusinessPartnerBalanceJournalEditApp.BUSINESS_OBJECT_CODE;
    ...
    protected viewShowed(): void {
        ...
        if (ibas.objects.isNull(this.editData)) {
            // 创建编辑对象实例
            this.editData = new bo.BusinessPartnerBalanceJournal();
    ...
    protected createData(clone: boolean): void {
        ...
        let createData: Function = function (): void {
            if (clone) {
                ...
                // 新建对象
                that.editData = new bo.BusinessPartnerBalanceJournal();
...
/** 视图-业务伙伴余额记录 */
export interface IBusinessPartnerBalanceJournalEditView extends ibas.IBOEditView {
    /** 显示数据 */
