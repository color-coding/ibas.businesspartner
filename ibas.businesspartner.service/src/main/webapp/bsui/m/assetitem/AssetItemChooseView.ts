...
namespace businesspartner {
    export namespace ui {
        export namespace m {
            export class AssetItemChooseView extends ibas.BOChooseView implements app.IAssetItemChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.AssetItem;
                }
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_assetitem_code"),
                                        bindingValue: {
                                            path: "code",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_assetitem_amountunit"),
                                        bindingValue: {
                                            path: "amountUnit",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
