...
/** 业务伙伴联系人 */
export class ContactPerson extends BOSimple<ContactPerson> implements IContactPerson {
    ...
    get activated(): emYesNo {
        return this.getProperty<emYesNo>(ContactPerson.PROPERTY_ACTIVATED_NAME);
    }
    /** 设置-有效的 */
