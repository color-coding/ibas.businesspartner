...
namespace businesspartner {
    export namespace ui {
        export namespace c {
             ...
             * 列表视图-业务伙伴地址
             */
            export class AddressListView extends ibas.BOListView implements app.IAddressListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.Address;
                }
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                ...
                                template: new sap.extension.m.DataLink("", {
                                    objectCode: bo.Address.BUSINESS_OBJECT_CODE,
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_address_group"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_address_remark1"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "remark1",
                                    type: new sap.extension.data.Alphanumeric()
