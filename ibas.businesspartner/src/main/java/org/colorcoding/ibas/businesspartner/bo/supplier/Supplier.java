...
@BusinessObjectUnit(code = Supplier.BUSINESS_OBJECT_CODE)
public class Supplier extends BusinessObject<Supplier>
		implements ISupplier, IDataOwnership, IApprovalData, IBOSeriesKey, IBOTagDeleted, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 1247853466801286264L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Supplier.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_BP_OSUP";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_BP_SUPPLIER";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Supplier";
