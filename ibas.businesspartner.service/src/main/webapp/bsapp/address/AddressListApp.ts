...
namespace businesspartner {
    export namespace app {
        ...
        /** 列表应用-业务伙伴地址 */
        export class AddressListApp extends ibas.BOListApplication<IAddressListView, bo.Address> {

            /** 应用标识 */
            static APPLICATION_ID: string = "a4b876ef-30f7-46c3-9a6e-c1a186c70b3a";
            /** 应用名称 */
            static APPLICATION_NAME: string = "businesspartner_app_address_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.Address.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = AddressListApp.APPLICATION_ID;
                this.name = AddressListApp.APPLICATION_NAME;
                this.boCode = AddressListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.Address | bo.Address[]): void {
                let beDeleteds: ibas.IList<bo.Address> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-业务伙伴地址 */
        export interface IAddressListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
