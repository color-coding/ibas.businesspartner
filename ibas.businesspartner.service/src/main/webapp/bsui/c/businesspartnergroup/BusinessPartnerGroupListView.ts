...
import { IBusinessPartnerGroupListView } from "../../../bsapp/businesspartnergroup/index";

/**
 * 列表视图-业务伙伴组
 */
export class BusinessPartnerGroupListView extends ibas.BOListView implements IBusinessPartnerGroupListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
    ...
    darw(): any {
        ...
        this.table = new sap.ui.table.Table("", {
            ...
            columns: [
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_businesspartnergroup_name"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "name"
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.BusinessPartnerGroup>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
    ...
    getSelecteds(): bo.BusinessPartnerGroup[] {
        return utils.getTableSelecteds<bo.BusinessPartnerGroup>(this.table);
    }
}
