package org.colorcoding.ibas.businesspartner.bo.businesspartnergroup;
...
@BusinessObjectUnit(code = BusinessPartnerGroup.BUSINESS_OBJECT_CODE)
public class BusinessPartnerGroup extends BusinessObject<BusinessPartnerGroup>
		implements IBusinessPartnerGroup, IBOSeriesKey, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -1612108623385277920L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = BusinessPartnerGroup.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_BP_OCRG";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_BP_BPGROUP";
