...
namespace businesspartner {
    export namespace app {
        ...
        export class CustomerListApp extends ibas.BOListApplication<ICustomerListView, bo.Customer> {
            ...
            /** 应用标识 */
            static APPLICATION_ID: string = "fca28cdf-84d5-4371-8da3-f61dc4aaae5a";
            /** 应用名称 */
            static APPLICATION_NAME: string = "businesspartner_app_customer_list";
            /** 业务对象编码 */
            ...
            protected registerView(): void {
                ...
                this.view.customerGroupEvent = this.customerGroup;
            }
            /** 视图显示后 */
