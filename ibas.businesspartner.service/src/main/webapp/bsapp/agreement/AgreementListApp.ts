...
namespace businesspartner {
    export namespace app {
        /** 列表应用-协议/合同 */
        export class AgreementListApp extends ibas.BOListApplication<IAgreementListView, bo.Agreement> {
            /** 应用标识 */
            static APPLICATION_ID: string = "ffad42d6-145b-44bc-be1b-6a8217451363";
            /** 应用名称 */
            static APPLICATION_NAME: string = "businesspartner_app_agreement_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.Agreement.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = AgreementListApp.APPLICATION_ID;
                this.name = AgreementListApp.APPLICATION_NAME;
                this.boCode = AgreementListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.Agreement): void {
                ...
                let app: AgreementViewApp = new AgreementViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.Agreement | bo.Agreement[]): void {
                let beDeleteds: ibas.IList<bo.Agreement> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-协议/合同 */
        export interface IAgreementListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
