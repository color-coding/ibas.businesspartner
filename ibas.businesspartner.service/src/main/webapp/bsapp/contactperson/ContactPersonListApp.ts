...
namespace businesspartner {
    export namespace app {
        ...
        /** 列表应用-业务伙伴联系人 */
        export class ContactPersonListApp extends ibas.BOListApplication<IContactPersonListView, bo.ContactPerson> {

            /** 应用标识 */
            static APPLICATION_ID: string = "bc374c27-877d-46b2-9a51-a570f6266c7f";
            /** 应用名称 */
            static APPLICATION_NAME: string = "businesspartner_app_contactperson_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.ContactPerson.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = ContactPersonListApp.APPLICATION_ID;
                this.name = ContactPersonListApp.APPLICATION_NAME;
                this.boCode = ContactPersonListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.ContactPerson | bo.ContactPerson[]): void {
                let beDeleteds: ibas.IList<bo.ContactPerson> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-业务伙伴联系人 */
        export interface IContactPersonListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
