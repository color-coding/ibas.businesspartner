...
import { BusinessPartnerGroupViewApp } from "./BusinessPartnerGroupViewApp";
import { BusinessPartnerGroupEditApp } from "./BusinessPartnerGroupEditApp";

/** 列表应用-业务伙伴组 */
export class BusinessPartnerGroupListApp extends ibas.BOListApplication<IBusinessPartnerGroupListView, bo.BusinessPartnerGroup> {

    /** 应用标识 */
    static APPLICATION_ID: string = "309add91-1dcd-47ab-b8cb-a91073a2ed51";
    /** 应用名称 */
    static APPLICATION_NAME: string = "businesspartner_app_businesspartnergroup_list";
    /** 业务对象编码 */
    static BUSINESS_OBJECT_CODE: string = bo.BusinessPartnerGroup.BUSINESS_OBJECT_CODE;
    /** 构造函数 */
    constructor() {
        super();
        this.id = BusinessPartnerGroupListApp.APPLICATION_ID;
        this.name = BusinessPartnerGroupListApp.APPLICATION_NAME;
        this.boCode = BusinessPartnerGroupListApp.BUSINESS_OBJECT_CODE;
    ...
    protected viewData(data: bo.BusinessPartnerGroup): void {
        ...
        let app: BusinessPartnerGroupViewApp = new BusinessPartnerGroupViewApp();
        app.navigation = this.navigation;
        app.viewShower = this.viewShower;
        app.run(data);
