...
namespace businesspartner {
    export namespace ui {
        export namespace m {
            /** 选择视图-付款条款 */
            export class PaymentTermChooseView extends ibas.BOChooseView implements app.IPaymentTermChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.PaymentTerm;
                }
                /** 绘制视图 */
                draw(): any {
                    let that: this = this;
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_paymentterm_code"),
                                        bindingValue: {
                                            path: "code",
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_paymentterm_name"),
                                        bindingValue: {
                                            path: "name",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
